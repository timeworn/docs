  ...
  return (
    <>
      ...
      <Base.SidebarDrawerContent
        className={cn(
          "bg-fd-background data-[state=open]:animate-fd-sidebar-in data-[state=closed]:animate-fd-sidebar-out fixed inset-y-0 end-0 z-40 flex w-[85%] max-w-95 flex-col border-s text-[0.9375rem] shadow-lg",
          className,
        )}
        {...props}
      >
